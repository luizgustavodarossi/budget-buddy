...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference("CreditCard.count") do
      post credit_cards_url, params: { credit_card: { balance: @credit_card.balance, closes_day: @credit_card.closes_day, expire_day: @credit_card.expire_day, kind: @credit_card.kind, name: @credit_card.name } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { balance: @credit_card.balance, closes_day: @credit_card.closes_day, expire_day: @credit_card.expire_day, kind: @credit_card.kind, name: @credit_card.name } }
